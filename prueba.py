...
if __name__ == '__main__':
    ...
    # Ejemplo de impresión de una revista
    #print("Ejemplo:", list(revistas.items())[:1])  # muestra una entrada de ejemplo
